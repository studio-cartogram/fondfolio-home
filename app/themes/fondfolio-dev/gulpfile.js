...
gulp.task(
  "fonts:clean",
  [],
  lazyQuire(require, "./gulp/core/recipes/fonts/clean")
);
gulp.task(
  "fonts:dev",
  ["fonts:clean"],
...
gulp.task("svg:dev", [], lazyQuire(require, "./gulp/core/recipes/svg/dev"));
gulp.task("svg:prod", [], lazyQuire(require, "./gulp/core/recipes/svg/prod"));
gulp.task(
  "svg:watch",
  ["svg:dev"],
  lazyQuire(require, "./gulp/core/recipes/svg/watch")
);
...
gulp.task(
  "theme:clean",
  [],
  lazyQuire(require, "./gulp/core/recipes/theme/clean")
);
gulp.task(
  "theme:dev",
  ["theme:clean"],
  lazyQuire(require, "./gulp/core/recipes/theme/dev")
);
gulp.task(
  "theme:prod",
  ["theme:clean"],
  lazyQuire(require, "./gulp/core/recipes/theme/prod")
);
gulp.task(
  "theme:watch",
  ["theme:dev"],
  lazyQuire(require, "./gulp/core/recipes/theme/watch")
);
