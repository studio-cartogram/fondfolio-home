class Slideshow {
  ...
  nextSlide = () => {
    ...
    this.slides[this.currentSlide].className =
      "js-slide slideshow__slide is-active";
    const height = this.slides[this.currentSlide].querySelector(".testimonial")
      .clientHeight;
    document.querySelector("#js-slideshow").style.height =
      this.slides[this.currentSlide].querySelector(".testimonial")
        .clientHeight + "px";
  };
}
